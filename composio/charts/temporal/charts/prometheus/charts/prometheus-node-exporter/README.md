...
![Version: 4.36.0](https://img.shields.io/badge/Version-4.36.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.8.1](https://img.shields.io/badge/AppVersion-1.8.1-informational?style=flat-square)
...
| kubeRBACProxy.enableHostPort | bool | `false` |  |
| kubeRBACProxy.enableProxyEndpointsHostPort | bool | `false` |  |
| kubeRBACProxy.enabled | bool | `false` |  |
| kubeRBACProxy.env | object | `{}` |  |
...
| kubeRBACProxy.port | int | `8100` |  |
| kubeRBACProxy.portName | string | `"http"` |  |
...
| terminationMessageParams.enabled | bool | `false` |  |
| terminationMessageParams.terminationMessagePath | string | `"/dev/termination-log"` |  |
| terminationMessageParams.terminationMessagePolicy | string | `"File"` |  |
