...
![Version: 25.22.0](https://img.shields.io/badge/Version-25.22.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.53.0](https://img.shields.io/badge/AppVersion-v2.53.0-informational?style=flat-square)
...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | alertmanager | 1.11.* |
| https://prometheus-community.github.io/helm-charts | kube-state-metrics | 5.20.* |
| https://prometheus-community.github.io/helm-charts | prometheus-node-exporter | 4.36.* |
| https://prometheus-community.github.io/helm-charts | prometheus-pushgateway | 2.13.* |
...
| configmapReload.prometheus.image.tag | string | `"v0.74.0"` |  |
